				...
				<div className="content">
					<div className="containerContent">
						<div style={{
							padding:'20px 0',
							fontSize:'22px'
						}} className="font-bold">Pengiriman</div>
						<div className="cart-root-parent">
							<div className="w-full">
								<div className="flex flex-col p-[20px] bg-[#ffe6a2] rounded-[10px] gap-[10px] font-bold">
									...
									<div className="text-sm">Jl. Kandang Mas 3 Rt 20 Rw 06, Kampung Melayu, Kota Bengkulu, Bengkulu, 6282280994738</div>
								...
								<div>
									{
										cart_items.map((item,i)=>(
											<div className="p-[20px] bg-[#ffe6a2] rounded-[10px] gap-[10px] mt-[5px] flex flex-col">
													...
													<div className="flex gap-[10px] items-start w-full">
														...
														<div className="flex flex-col justify-between w-full">
															<div className="flex justify-between">
																...
																<div className="bold">
																	{item.product.count} x {item.product.price}
																</div>
															</div>
