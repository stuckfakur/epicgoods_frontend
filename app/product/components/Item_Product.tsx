...
export default function _ItemProduct(props: Props) {
    return (
        <div key={props.key} style={{background:'whitesmoke',borderRadius:'10px',display:'flex',flexDirection:'column',alingItem:'center',width:'200px'}}>
            <div style={{
                width:'100%',
                height:'200px',
                borderRadius:'10px'
            ...
            <div className="details_container">
                ...
                <div className="product_price">
                    ...
                    <div className="price_old sliced-content"><s>{props.product_price.toLocaleString({})}</s></div>
                </div>
